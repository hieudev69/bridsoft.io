...
class QuadMenu_Welcome extends QuadMenu_Panel {
  ...
  function add_menu() {
    add_menu_page(self::$panel_slug, QUADMENU_PLUGIN_NAME, 'edit_posts', self::$panel_slug, array($this, 'add_panel'), plugins_url('/assets/backend/img/icon.png', QUADMENU_PLUGIN_FILE));
    add_submenu_page(self::$panel_slug, esc_html__('Welcome', 'quadmenu'), esc_html__('Welcome', 'quadmenu'), 'edit_posts', self::$panel_slug, array($this, 'add_panel'));
  }
  ...
  function add_panel() {
    ...
    include (QUADMENU_PLUGIN_DIR . '/includes/panel/pages/welcome.php');
  }
  ...
  function system() {
    ...
    $response_code = wp_remote_retrieve_response_code(wp_remote_get(QUADMENU_PLUGIN_URL . 'assets/frontend/less/quadmenu-locations.less', array(
        'timeout' => 20,
