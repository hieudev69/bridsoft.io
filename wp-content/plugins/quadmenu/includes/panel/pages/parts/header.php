<div class="wrap about-wrap full-width-layout qlwrap">
  ...
  <?php printf('<a href="%s" target="_blank"><div style="
               ...
               width: 140px;
               " class="wp-badge">%s</div></a>', 'https://quadlayers.com/?utm_source=quadmenu_admin', plugins_url('/assets/backend/img/quadlayers.jpg', QUADMENU_PLUGIN_FILE), esc_html__('QuadLayers', 'quadmenu')); ?>

</div>
<?php
if (isset($submenu[QuadMenu_Panel::$panel_slug])) {
  if (is_array($submenu[QuadMenu_Panel::$panel_slug])) {
    ?>
    <div class="wrap about-wrap full-width-layout qlwrap">
      <h2 class="nav-tab-wrapper">
        <?php
        foreach ($submenu[QuadMenu_Panel::$panel_slug] as $tab) {
